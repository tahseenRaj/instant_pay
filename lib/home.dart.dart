        ...
        Column(
          children: [
            Row(
              mainAxisAlignment: MainAxisAlignment.spaceBetween,
              children: [
                billingBtn(Colors.deepPurpleAccent, 'Scan QR Code',
                    const Icon(Icons.qr_code_scanner)),
                const SizedBox(
                  width: 15,
                ),
                billingBtn(Colors.green, 'Send To Contact',
            ...
            Row(
              mainAxisAlignment: MainAxisAlignment.spaceBetween,
              children: [
                billingBtn(const Color(0xFF8EC62D), 'Send To Bank',
          ...
          children: [
            Row(
              ...
              children: [
                ...
                billingBtn(
                    Colors.cyan, 'Electricity Bill', const Icon(Icons.sunny)),
              ],
            ),
            const SizedBox(
              height: 20,
        ...
        Column(
          children: [
            Row(
              ...
              children: [
                peoples('IronMan',
                    'https://encrypted-tbn0.gstatic.com/images?q=tbn:ANd9GcTsuv4pfCUs_CCEfmv7WniTKEU6i7DbKJ5BKw&usqp=CAU'),
                const SizedBox(
                  width: 10,
                ),
                peoples('Thor',
                    'https://e7.pngegg.com/pngimages/759/233/png-clipart-thor-illustration-thor-cartoon-marvel-cinematic-universe-marvel-animation-comics-thor-avengers-superhero.png'),
                const SizedBox(
                  width: 10,
                ),
                peoples('Peter',
